...
# 自适应学习率
print("\n自适应学习率:")
linearRegressor_GD = LR_GD(epochs=20000, rate=0.000001, alg="adaptive")
...
# Adagrad
print("\nAdagrad:")
linearRegressor_GD = LR_GD(epochs=20000, rate=0.01, alg="adagrad", batch_size=100, m=0.9, nesterov=True)
linearRegressor_GD.fit(X_train, Y_train)
Y_Pred = linearRegressor_GD.predict(X_test)
print(Y_Pred)
print(linearRegressor_GD.meanSquareError(X_test, Y_test))
...
# RMSprop
print("\nRMSprop:")
linearRegressor_GD = LR_GD(epochs=20000, rate=0.001, alg="rmsprop", batch_size=100, m=0.5)
linearRegressor_GD.fit(X_train, Y_train)
Y_Pred = linearRegressor_GD.predict(X_test)
print(Y_Pred)
print(linearRegressor_GD.meanSquareError(X_test, Y_test))
...
# AdaDelta
print("\nAdaDelta:")
linearRegressor_GD = LR_GD(epochs=20000, rate=0.0001, alg="adadelta", batch_size=100)
linearRegressor_GD.fit(X_train, Y_train)
Y_Pred = linearRegressor_GD.predict(X_test)
print(Y_Pred)
print(linearRegressor_GD.meanSquareError(X_test, Y_test))
